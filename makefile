...
# Generated by qmake (2.01a) (Qt 4.7.2) on: ven. févr. 10 21:03:25 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/isingmodel1.0.0/ && $(COPY_FILE) --parents UTILS/include/menu.h .tmp/isingmodel1.0.0/ && $(COPY_FILE) --parents UTILS/src/menu.C main.C .tmp/isingmodel1.0.0/ && (cd `dirname .tmp/isingmodel1.0.0` && $(TAR) isingmodel1.0.0.tar isingmodel1.0.0 && $(COMPRESS) isingmodel1.0.0.tar) && $(MOVE) `dirname .tmp/isingmodel1.0.0`/isingmodel1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/isingmodel1.0.0
